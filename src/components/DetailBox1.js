...
class DetailBox1 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={`flex flex-col  border-2 border-solid ${rounded ? 'rounded-full w-36 h-36' : 'rounded-lg w-64 h-28'} relative m-4 shadow-lg ${marginTopLg ? 'mt-28' :''} ${marginRightLg ? 'mr-14' :''}`} style={{background:'linear-gradient(90deg, rgba(81,180,151,1) 0%, rgba(50,181,175,1) 35%, rgba(1,173,209,1) 100%)',color:'#19435c',fontWeight:'500'}}>
