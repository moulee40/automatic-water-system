...
class DetailBox3 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={`flex flex-col w-80 h-28 border-2 border-solid border-gray-200 rounded m-4 shadow-lg ${marginTopLg ? 'mt-28' :''}`} style={{background:'linear-gradient(90deg, rgba(81,180,151,1) 0%, rgba(50,181,175,1) 35%, rgba(1,173,209,1) 100%)',color:'#19435c',fontWeight:'500'}}>
