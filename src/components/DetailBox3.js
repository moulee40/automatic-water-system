...
class DetailBox3 extends React.Component {
  ...
  render() {
      const {marginTopLg,rightArrow,pvValue,ovValue,title,LMTDvalue,TTDvalue,tagValue,isTagPresent} = this.props;
    return (
        ...
        <div className='flex justify-center items-center flex-1 border-b-2 border-solid text-gray-200' style={{borderColor:'#105867'}}>{title}</div>
        {isTagPresent && <div className='flex justify-center items-center flex-1 border-b-2 border-solid' style={{borderColor:'#105867'}}>{tagValue}</div>}
        <div className='flex flex-col flex-1'>
            <div className='flex flex-1 border-b-2 border-solid' style={{borderColor:'#105867'}}>
                ...
                <div className='flex-1 text-center font-bold' >{LMTDvalue}</div>
            </div>
            <div className='flex flex-1'>
                <div className='flex-1 text-center border-r-2 border-solid' style={{maxWidth:100,borderColor:'#105867'}}>TTD</div>
                <div className='flex-1 text-center font-bold'>{TTDvalue}</div>
            </div>
        </div>
      </div>
