...
class DetailBox3 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={`flex flex-col w-80 h-28 border-2 border-solid border-black rounded m-4 ${marginTopLg ? 'mt-28' :''}`}>
        ...
        <div className='flex flex-col flex-1'>
            <div className='flex flex-1 border-b-2 border-solid border-black'>
                <div className='flex-1 text-center border-r-2 border-solid border-black' style={{maxWidth:100}}>LMTD</div>
                <div className='flex-1 text-center'>{LMTDvalue}</div>
            </div>
            <div className='flex flex-1'>
                <div className='flex-1 text-center border-r-2 border-solid border-black' style={{maxWidth:100}}>TTD</div>
