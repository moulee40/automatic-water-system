...
{/* 
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a onClick={()=>this.handleNavChange('dashboard')} class={`flex items-center px-4 py-2 text-gray-700 rounded-md ${(localStorage.getItem("currentLabel") === null || localStorage.getItem("currentLabel") === 'dashboard') ? 'bg-gray-200' : ''}`} href="/home">
                ...
                <a onClick={()=>this.handleNavChange('accounts')} class={`flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md ${localStorage.getItem("currentLabel") === 'accounts' ? 'bg-gray-200' : ''} dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700`} href="/account">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
