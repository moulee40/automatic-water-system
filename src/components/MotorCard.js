...
class MotorCard extends React.Component {
  ...
  render() {
    return (
        <div class="max-w-xs overflow-hidden mr-16 bg-white rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 max-h-[296px]" onClick={this.props.onClick}>
        <div class="px-4 py-2">
        ...
        <img class="object-cover w-full h-48 mt-2" src={CoolingTower} alt="NIKE AIR"/>

        <div class="flex items-center justify-between px-4 py-2 bg-gray-600">
            <h1 class="text-lg font-bold text-white">Status</h1>
            <h1 class="text-lg font-bold text-white">ON</h1>
